...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="leftComponent col-md-5">
                <img src="img/ceclogo.png" alt="Leave Image" class="img-fluid">
            </div>
            <!-- leftComponent ends -->
    ...
    <div class="content2">
        ...
        <p class="text-start">
            Empowering students and staff with a seamless leave management experience — because time and clarity matter.
        </p>
    </div>
    ...
    <div>
      ...
      <p class="text-center">Developed By Bilal and Suhail</p>
    </div>
    </footer>
</body>
</html>
